...
TOOL_CATEGORIES = {
    "tts": {
        ...
        "providers": [
            {
                "name": "Termux Android TTS",
                "badge": "local · Android",
                "tag": "Uses termux-tts-speak; no voice API or model download",
                "env_vars": [],
                "tts_provider": "termux",
            },
            {
    ...
    "stt": {
        ...
        "providers": [
            {
                "name": "Termux Android Speech-to-Text",
                "badge": "local · Android",
                "tag": "Uses termux-speech-to-text; no Whisper model or API key",
                "env_vars": [],
                "stt_provider": "termux",
            },
            {
