...
DEFAULT_CONFIG = {
    ...
    "tts": {
        ...
        # "edge" (free) | "termux" (Android local) | "elevenlabs" (premium) | "openai" | "xai" | "minimax" | "mistral" | "gemini" | "deepinfra" | "neutts" (local) | "kittentts" (local) | "piper" (local)
        "provider": "edge",
        "termux": {
            # Optional Android TTS settings. The system default is used when
    ...
    "stt": {
        ...
        "provider": "local",  # En Termux, local se redirige a termux-speech-to-text
        "termux": {
            # Android's system recognizer. The default is used when omitted.
            # "timeout": 120,
            # "progress": false,
        },
