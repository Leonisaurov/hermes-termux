...
> Si el teléfono se calienta durante la compilación, puedes limitarla con `~/.local/bin/tcr -j 1 -n 19 -- bash scripts/install.sh --skip-setup`. `tcr` aplica afinidad de CPU, prioridad baja, `ionice` y compilación nativa serial.
>
