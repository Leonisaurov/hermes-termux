...
class DaemonThreadPoolExecutor(ThreadPoolExecutor):
    ...
    def _adjust_thread_count(self) -> None:
        ...
        # no _threads_queues registration.  Python 3.14 changed the worker
        # initializer API from ``_initializer/_initargs`` to a prepared
        # worker context, so support both private stdlib layouts here.
        ...
        if num_threads < self._max_workers:
            ...
            if hasattr(self, "_create_worker_context"):
                # Python 3.14+: _worker(executor_reference, context, queue)
                worker_args = (
                ...
                # Python <= 3.13: _worker(executor_reference, queue,
